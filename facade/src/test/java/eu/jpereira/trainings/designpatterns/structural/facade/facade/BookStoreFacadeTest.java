...
public class BookStoreFacadeTest extends AbstractClientTest {
	...
	public void testPlaceOrder() {
		...
		// Verify behavior
		verify(warehouseService).dispatch(dummyOrder); //checks that the dispatch methord of warehouse mock object was called exactly once with dummyDispatchReceipt as argument
	...
	protected BookstoreFacade createFacade() {
		Bookstore facade = new Bookstore();
