...
public class Report {
	 ...
	 * @param string
	 * changes:
	 *  replaced the String type to ReportBuilder builder, and added buildReport
	 *  function to ReportBuilder Interface, each class implementing this interface
	 *  has it's own implementation of buildReport function
	 */
